...
public class ScheduleServiceimpl implements ScheduleService{
	...
	public Schedule getScheduleById(long scheduleId) {
		...
		return scheduledao.findById(scheduleId).orElseThrow(()->new  
				DataNotFoundException("Schedule","Id",scheduleId));
	}
	...
	public Schedule updateSchedule(Schedule schedule, long scheduleId) {
		Schedule existingschedule=scheduledao.findById(scheduleId).orElseThrow(()->new  
		DataNotFoundException("Schedule","Id",scheduleId));
